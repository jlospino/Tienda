  ...
  return _c(
    ...
    _vm._l(_vm.products, function(item, index) {
      return _c(
        ...
        {
          key: index,
          staticClass: "row no-gutters bg-light position-relative mb-2"
        },
        [
          ...
          _vm._v(" "),
          _c("div", { staticClass: "col-md-9 position-static p-4 pl-md-0" }, [
            ...
            _c("p", [
              _vm._v("Precio: "),
              _c("b", [_vm._v("$ " + _vm._s(_vm.formatPrice(item.price)))])
            ]),
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(item.quantity) + " Unidades Disponibles")]),
            _vm._v(" "),
            _c(
              "a",
              {
                staticClass: "btn btn-primary",
                attrs: { href: "product/" + item.slug }
              },
